...
- **Zero-Trust Network Isolation**: All outgoing traffic is blocked by default. You only have access to allowlisted domains specifically configured as active connectors for the current organization (e.g. Datadog, GitHub, Slack).
