...
export async function seedOrg(orgId: string, orgName: string) {
  console.log(`Seeding organization: ${orgName} (${orgId})...`);

  // Clear old data
  console.log(`Cleaning up old mock data for ${orgName}...`);
  ...
  console.log(`Seeding new mock data for ${orgName}...`);
  ...
  console.log(`✓ Seeded fix patterns for ${orgName}`);

  // 2. Seed Incidents, Investigations, and Root Causes
  ...
  console.log(`✓ Seeded incident 2 (High, Investigating) for ${orgName}`);
  ...
  console.log(`✓ Seeded incident 3 (Medium, Resolved) for ${orgName}`);
  ...
  console.log(`✓ Seeded incident 4 (Medium, Resolved) for ${orgName}`);
  ...
  console.log(`✓ Seeded incident 5 (Low, Resolved) for ${orgName}`);

  console.log(`✓ Seeding complete for organization: ${orgName}`);
}
